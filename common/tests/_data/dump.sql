...
INSERT INTO `auth_item_child` VALUES ('admin','administrateRbac'),('admin','administrateUser'),('administrateUser','blockUser'),('administrateUser','createUser'),('administrateUser','deleteUser'),('updateSelf','showSelfProfile'),('updateUser','showUserProfile'),('user','updateSelf'),('updateSelf','updateSelfAccount'),('updateSelfAccount','updateSelfPassword'),('updateSelf','updateSelfProfile'),('administrateUser','updateUser'),('updateUser','updateUserAccount'),('updateUserAccount','updateUserPassword'),('updateUser','updateUserProfile'),('admin','user');
